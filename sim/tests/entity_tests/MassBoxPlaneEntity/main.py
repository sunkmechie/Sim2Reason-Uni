...
def main(cfg: DictConfig):
    ...
    ##### INFO #####
    # MassBoxPlaneEntity: A box on a plane with a mass on top and a hanging mass on the right
    #   - Connected via tendon to a ConstantForceFixedPulley
    #   - plane_slope=0.55 (radians ≈ 31.5°), box_mass=1.56, top_mass=0.6, right_mass=0.28
    #   - No friction
    ...
    print(f"\n{'='*60}")
    print(f"PHYSICS ASSERTIONS — MassBoxPlaneEntity")
    print(f"  {N} timesteps, g={g_mag}")
    print(f"{'='*60}\n")

    # Discover all bodies with position data
    body_data = {}
