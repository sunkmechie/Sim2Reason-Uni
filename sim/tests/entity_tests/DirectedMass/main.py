...
def main(cfg: DictConfig):
    ...
    ##### INFO #####
    # DirectedMass scene:
    #   - Two MassWithFixedPulley entities (1 kg each) as anchors
    #   - DirectedMass entity (2 kg) with two pulley connections (side_1, side_2)
    #   - Connected via two separate tendons
    #   - System hangs under gravity with constraint forces from tendons
    ...
    print(f"\n{'='*60}")
    print(f"PHYSICS ASSERTIONS — DirectedMass")
