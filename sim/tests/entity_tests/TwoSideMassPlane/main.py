...
def main(cfg: DictConfig):
    ...
    ##### INFO #####
    # TwoSideMassPlane scene:
    #   - TwoSideMassPlane entity: mass 1.0 kg, on a plane with two connecting sides
    #   - Connected to two MassWithFixedPulley entities via tendons (left and right)
    #   - Left: MassPrismPlane type (17.07 kg on a wedge)
    #   - Right: MassPlane type (6.29 kg on a 10° incline)
    ...
    print(f"\n{'='*60}")
    print(f"PHYSICS ASSERTIONS — TwoSideMassPlane")
