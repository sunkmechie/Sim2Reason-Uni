...
def main(cfg: DictConfig):
    ...
    ##### INFO #####
    # MassWithMovablePulley scene:
    #   - MassWithMovablePulley entity: 1 movable pulley with mass 0.43 kg, hanging mass 1.8 kg
    #   - MassWithReversedMovablePulley entity: 2 hanging masses (1.94, 6.05 kg), pulley 1.37 kg
    #   - Two MassWithFixedPulley entities (1.4 kg, 1.62 kg)
    #   - Complex pulley system with 2 tendons
    ...
    print(f"\n{'='*60}")
    print(f"PHYSICS ASSERTIONS — MassWithMovablePulley")
