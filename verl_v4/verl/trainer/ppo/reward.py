...
def load_reward_manager(
    config: DictConfig, tokenizer: Any, num_examine: int, reward_options=None, simple_eval=False, **reward_kwargs: Any
...
def compute_reward(data: DataProto, reward_fn, config=None, reward_fn_name=None):
    """
    ...
    """
    try:
        reward_result = reward_fn(data, return_dict=True, config=config, reward_fn_name=reward_fn_name)
        reward_tensor = reward_result["reward_tensor"]
        reward_extra_infos_dict = reward_result.get("reward_extra_info", {})
    except Exception as e:
        print(f"Error in reward_fn: {e}")
        reward_tensor = reward_fn(data, return_dict=True, config=config, reward_fn_name=reward_fn_name)
